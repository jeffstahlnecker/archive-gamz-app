...
interface IconCalendarProp {
  style?: string
}

export const IconCalendar: React.FC<IconCalendarProp> = ({ style }) => {
  return (
    <svg
      className={
        style || 'text-gray-400 group-hover:text-gray-300 mr-4 h-6 w-6'
      }
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
...
export const IconInbox: React.FC = () => {
  return (
    <svg
      className="text-gray-400 group-hover:text-gray-300 mr-4 h-6 w-6"
      xmlns="http://www.w3.org/2000/svg"
...
export const IconChartBar: React.FC = () => {
  return (
    <svg
      className="text-gray-400 group-hover:text-gray-300 mr-4 h-6 w-6"
      xmlns="http://www.w3.org/2000/svg"
